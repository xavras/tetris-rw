...
public class Tetrion {
	...
	public final static int BLOCK_S = 3;
	public final static int BLOCK_Z = 4;
	public final static int BLOCK_I = 5;
	public final static int BLOCK_O = 6;
	
	public Block[][] tet = new Block[4][4];//(1;1) is center
	public int type;
	public int coord[] = {0,-5};
